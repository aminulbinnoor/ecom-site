...
export default {
  ...
  mounted() {
    // this.slides = [
    //   { path: "/images/building/mahabub-triplex-view-01.jpg" },
    //   { path: "/images/building/mahabub-triplex-view-02.jpg" },
    //   { path: "/images/building/mahabub-triplex-view-03.jpg" },
    //   { path: "/images/building/mahabub-triplex-view-04.jpg" },
    //   { path: "/images/building/mahabub-triplex-view-05.jpg" },
    //   { path: "/images/building/mahabub-triplex-view-06.jpg" },
    //   { path: "/images/building/mahabub-triplex-view-07.jpg" },
    //   { path: "/images/building/mahabub-triplex-view-08.jpg" },
    // ];
  },
