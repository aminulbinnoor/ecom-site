          ...
          <div class="privew-stack" v-if="slideData.length">
            ...
            >
              <vue-glide-slide
                ...
                :key="index"
              >
                <router-link :is="deactiveLink ? 'span' : 'router-link'" :to="`${extraRoute}${theme.slug}`" class="slide-image">
                  <img v-if="theme.images"
                    :data-src="cdn +
                    '/' +
                    theme.images[0].path +
                    'hdpi/' +
